...
silent! normal! zE
let &fdl = &fdl
let s:l = 34 - ((5 * winheight(0) + 13) / 26)
...
wincmd w
argglobal
if bufexists(fnamemodify("src/assets.c", ":p")) | buffer src/assets.c | else | edit src/assets.c | endif
balt src/list.c
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 79 - ((5 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 79
...
silent! normal! zE
let &fdl = &fdl
let s:l = 114 - ((13 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 114
...
wincmd w
argglobal
if bufexists(fnamemodify("src/inter.c", ":p")) | buffer src/inter.c | else | edit src/inter.c | endif
balt src/actions.c
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 62 - ((20 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 62
